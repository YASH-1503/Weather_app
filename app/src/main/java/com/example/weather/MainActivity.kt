...
class MainActivity : AppCompatActivity() {
    ...
    private fun fetchWeatherData(cityname: String) {
        ...
        val response =
            retrofit.getWeatherData(cityname, "4bd72db3da4a04ace0c49b7a752807ed", "metric")
    ...
    private fun onconditionchange(condition: String) {
        when (condition) {
            ...
            "Partly clouds", "Clouds", "Overcast", "Mist", "Foggy","Smoke","Haze","Fog" -> {
